...
pimg= loadImage("animation0.png");
pimg2= loadImage("animation2.png");
pimg3= loadImage("animation3.png");
win= loadSound();
lose= loadSound();
}
...
function setup() {
  ...
  player.addImage("player image 1",pimg);
  player.scale=0.25;
...
function draw() {
  ...
  if (keyDown(RIGHT_ARROW)){
    player.x=player.x+7;
    player.changeImage("player image 2",pimg2);
  }
  if (keyDown(LEFT_ARROW)){
    player.x=player.x-7;
    player.changeImage("player image 3",pimg3);
  }
